...
async def get_shortlist(
    ...
    assets = review_service.get_shortlist(db, cell_id, competitor_id, project_id)
...
async def accept_asset(
    ...
    return review_service.accept_asset(
        db, data.asset_id, data.observation_fields, project_id=project_id
    )
...
async def reject_asset(
    ...
    asset = review_service.reject_asset(
        db, data.asset_id, data.reason, project_id=project_id
    )
...
async def flag_asset(
    ...
    asset = review_service.flag_asset(
        db, data.asset_id, data.note, project_id=project_id
    )
...
async def get_insight(
    ...
    obj = insight_service.get_insight(db, insight_id, project_id)
    if not obj:
...
async def update_insight(
    ...
    return insight_service.update_insight(
        db, insight_id, data.model_dump(exclude_none=True), project_id=project_id
    )
...
async def delete_insight(
    ...
    insight_service.delete_insight(db, insight_id, project_id)
